...
const TESTIMONIALS = [
  {
    name: "Rahul Mehta",
    role: "Founder, TechVenture FZCO",
    text: "Decisive Zone made my company formation incredibly smooth. From free zone selection to visa processing, everything was handled professionally. Got my license in just 2 days.",
    rating: 5,
    nationality: "Indian",
  },
  {
    name: "Sarah Williams",
    role: "CEO, Williams Consulting LLC",
    text: "The team's knowledge of mainland regulations saved me thousands. They identified the best structure for my consultancy and handled everything end-to-end. Highly recommend.",
    rating: 5,
    nationality: "British",
  },
  {
    name: "Ahmed Al-Rashid",
    role: "Director, Gulf Imports FZE",
    text: "I've set up three companies through Decisive Zone over the past 5 years. Their consistency and attention to detail keeps me coming back. Best business setup firm in Dubai.",
    rating: 5,
    nationality: "Saudi",
  },
  {
    name: "Maria Santos",
    role: "Founder, Digital Nomad Agency",
    text: "As a freelancer moving to Dubai, I was overwhelmed by the process. Decisive Zone simplified everything — from my freelance visa to bank account setup. All done in a week.",
    rating: 5,
